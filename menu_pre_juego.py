...
def menu_pj(menu):
    ...
    ##Prueba imagen
    cuadro = tk.PhotoImage(file='Cuadro.png')
    cuadro_etiqueta = tk.Label(menu, highlightthickness=0, image=cuadro,)
    cuadro_etiqueta.place(x=30, y=30)

    ##Título
    lienzo_completo : tk.Canvas = tk.Canvas(menu, width= 400, height= 400, background= "white", highlightthickness=0)
    ...
    jugador_1 : str = nombre_jugador_1.get()
    ...
    jugador_2 : str = nombre_jugador_2.get()
    ...
    ##Botón de inicio
    boton_inicio : tk.Button = tk.Button(menu, text='Iniciar', font= ('Arial Black', 10), background="white" ,command= menu.destroy)
